...
Once the runtime starts, you can access the project at [http://localhost:8080/jakarta-product](http://localhost:8080/jakarta-product).
...
```
./mvnw clean package
docker build -t jakarta-product:v1 .
```

You can then run the Docker image by executing:

```
docker run -it --rm -p 8080:8080 jakarta-product:v1
```
